...
Enter the number of nodes:5
 Enter the adjacency list (node index, edge weight, space-separated):
Enter neighbors of node 0:2 1 3 3 5
 Enter neighbors of node 1:2 2 2 3 4
 Enter neighbors of node 2:1 1 4
 Enter neighbors of node 3:2 1 2 4 2
 Enter neighb
ors of node 4:1 1 5
